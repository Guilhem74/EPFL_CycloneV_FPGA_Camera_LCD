...
(
    ...
    localparam PAD3 = log2ceil(64'h10000810 - 64'h1000080c); 
    localparam PAD4 = log2ceil(64'h10000820 - 64'h10000810); 
    localparam PAD5 = log2ceil(64'h10000880 - 64'h10000860); 
    localparam PAD6 = log2ceil(64'h100008a0 - 64'h10000880); 
    ...
    // ( 0x1000080c .. 0x10000810 )
    if ( {address[RG:PAD3],{PAD3{1'b0}}} == 29'h1000080c   ) begin
    ...
    // ( 0x10000860 .. 0x10000880 )
    if ( {address[RG:PAD5],{PAD5{1'b0}}} == 29'h10000860   ) begin
            src_channel = 8'b00001000;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 0;
    end

    // ( 0x10000880 .. 0x100008a0 )
