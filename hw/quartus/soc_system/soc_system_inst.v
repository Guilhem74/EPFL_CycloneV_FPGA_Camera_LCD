	soc_system u0 (
		.camera_module_0_conduit_end_data_sensors_camera        (<connected-to-camera_module_0_conduit_end_data_sensors_camera>),        //                camera_module_0_conduit_end.data_sensors_camera
		.camera_module_0_conduit_end_debug                      (<connected-to-camera_module_0_conduit_end_debug>),                      //                                           .debug
		.camera_module_0_conduit_end_input_fval                 (<connected-to-camera_module_0_conduit_end_input_fval>),                 //                                           .input_fval
		.camera_module_0_conduit_end_input_lval                 (<connected-to-camera_module_0_conduit_end_input_lval>),                 //                                           .input_lval
		...
		.camera_module_0_clock_sink_2_clk                       (<connected-to-camera_module_0_clock_sink_2_clk>)                        //               camera_module_0_clock_sink_2.clk
	);
